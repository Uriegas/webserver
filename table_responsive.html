		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">En esta seccion podra agregar las vacaciones de los empleados de la organización.</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="password" class="form-control" placeholder="Digite el número RFC proporcionado por el SAT">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Ingrese la clave de indentificación como empleado">
									</div>
								</div>
