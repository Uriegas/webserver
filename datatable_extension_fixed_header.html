			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Modificar</span> - Eliminar Departamentos</h4>
						...
						<div class="breadcrumb justify-content-center">
							...
							<div class="breadcrumb-elements-item dropdown p-0">
								<a href="#" class="breadcrumb-elements-item dropdown-toggle" data-toggle="dropdown">
									<i class="list-icons-item text-primary-600"></i>
									Settings
								</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Eliminar Departamentos</h5>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title"><i class="icon-menu7 mr-2"></i> &nbsp;Eliminar Departamentos</h5>
							...
							<div class="modal-body">
								<div class="alert alert-info alert-dismissible alert-styled-left border-top-0 border-bottom-0 border-right-0">
					                <span class="font-weight-semibold">Esta a punto de elimnar un departamento</span>
					                <button type="button" class="close" data-dismiss="alert">×</button>
					            </div>

								<h6 class="font-weight-semibold"><i class="icon-law mr-2"></i> Eliminacion del departamento seleccionado</h6>
								<p>El departamento seleccionado sera eliminado de forma permamanente del sistema informatico</p>
					...
					<table class="table datatable-header-basic">
					    ...
					    <tbody>
					        <tr>
					            ...
					            <td>Ejecutivo</td>
					            <td>87160</td>
					            <td>http://planeacionempresa.com</td>
					            <td>1992</td>
					        </tr>
					        <tr>
					            <td>Marketing</td>
					            <td>Ejecutivo</td>
					            <td>87506</td>
					            <td>http://marketingempresa.com</td>
					            <td>2005</td>
					        </tr>
					        <tr>
					            <td>Tecnologia</td>
					            <td>Inovacion</td>
					            <td>87995</td>
					            <td>http://tecnologiaempresa.com</td>
					            <td>2016</td>
					        </tr>
					        <tr>
