...
<!--
			...
			<!-- Form inputs -->
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Agregar Empresas</h5>
						<div class="header-elements">
							<div class="list-icons">
		                		<a class="list-icons-item" data-action="collapse"></a>
		                		<a class="list-icons-item" data-action="reload"></a>
					...
					<div class="card-body">
						<p class="mb-4">En esta seccion podra agregar nuevas empresas a la organización.</p>
...
-->
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" maxlength="4" placeholder="Introduzca la fecha en que se creó la empresa">
									</div>
								</div>
<!--
								<div class="form-group row">
...
-->
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<textarea rows="3" cols="3" class="form-control" placeholder="Escriba una breve descripción de la empresa"></textarea>
									</div>
								</div>
							</fieldset>
<!--
