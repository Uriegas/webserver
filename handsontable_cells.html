			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Empresas</span> - Eliminar</h4>
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						...
						<div class="header-elements">
		                	...
		                	<tr>
									<td><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_iconified">Eliminar <i class="icon-trash"></i></button></td>
								</tr>
	                	</div>
					</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title"><i class="icon-menu7 mr-2"></i> &nbsp;Eliminar Empresas</h5>
							...
							<div class="modal-body">
								<div class="alert alert-info alert-dismissible alert-styled-left border-top-0 border-bottom-0 border-right-0">
					                <span class="font-weight-semibold">Esta a punto de elimnar una empresa de la lista de empresas</span>
					                <button type="button" class="close" data-dismiss="alert">×</button>
					            </div>

								<h6 class="font-weight-semibold"><i class="icon-law mr-2"></i> Eliminacion de la empresa seleccionada</h6>
								<p>La empresa seleccionada sera eliminada de forma permamanente del sistema informatico</p>
				...
				<table class="table datatable-fixed-left" width="100%">
						<thead>
					        <tr>
					            ...
					            <th>Nombre Accionista Mayor</th>
					            <th>RCF Accionista Mayor</th>
					            <th>Direccion Web</th>
					            <th>Fundacion</th>
					            <th>Descripción</th>
					        </tr>
					    ...
					    <tbody>
					        <tr>
					            <td>Telmex</td>
					            <td>Telmex Sa. de Cv.</td>
					            <td>Telecomm Mexico Sa. de Cv.</td>
					            <td>315,000</td>
					            <td>1,847,652,000</td>
					            <td>Slim Helu Carlos</td>
					            <td>SHC56003EM3</td>
					            <td>http://telmex.com</td>
					            <td>13 de diciembre de 1976</td>
					            <td>Distribución de servicios de telecomunicación</td>
					        </tr>
					        
					        <tr>
					            <td>GranD</td>
					            <td>GranD Sa. de Cv.</td>
					            <td>Charur Rodriguez Elias</td>
					            <td>352</td>
					            <td>500,000</td>
					            <td>Charur Rodriguez Elias</td>
					            <td>CRE59008TV0</td>
					            <td>http://grand.com</td>
					            <td>15 de agosto de 1995</td>
					            <td>Cadena de Suministros</td>
					        </tr>

					        <tr>
					            <td>Delymundo</td>
					            <td>Delymundo Sa. de Cv.</td>
					            <td>Sierrano De La Garza Victor</td>
					            <td>35</td>
					            <td>157,000</td>
					            <td>Cetura Ventura Esther</td>
					            <td>VER96008AE0</td>
					            <td>http://delymundo.com</td>
					            <td>27 de agosto de 1997</td>
					            <td>Empresa dedica a venta de pasteles de eventos</td>
					        </tr>
					        ...
					        <tr>
					            ...
					            <td>235</td>
					            <td>3,489,780,000</td>
					            <td>BlackRock Corp.</td>
					            <td>ROB66006TA0</td>
					            <td>http://facebook.com</td>
					            <td>13 de septiembre de 2004</td>
					            <td>Conexiones en la web para venta de publicidad</td>
					        </tr>
					        ...
					        <tr>
					            ...
					            <td>Fink Laurence</td>
					            <td>150,000</td>
					            <td>15,520,000,000</td>
					            <td>Fink Laurence</td>
					            <td>FIL99008ES0</td>
					            <td>http://blackrock.com</td>
					            <td>23 de febrero de 1994</td>
					            <td>Empresa dedica a la administración de actios</td>
					        </tr>
