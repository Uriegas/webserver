		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Formatos</span> - Editor de Departamentos</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">En esta seccion podra editar o modificar los departamentos existentes en la empresa.</p>
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						...
						<div class="header-elements">
		                	...
		                	<tr>
									<td><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_iconified">Editar <i class="icon-pencil7"></i></button></td>
								</tr>
	                	</div>
					</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title"><i class="icon-menu7 mr-2"></i> &nbsp;Editar Departamentos</h5>
							...
							<div class="modal-body">
								<div class="alert alert-info alert-dismissible alert-styled-left border-top-0 border-bottom-0 border-right-0">
					                <span class="font-weight-semibold">Esta a punto de editar un departamento</span>
					                <button type="button" class="close" data-dismiss="alert">×</button>
					            </div>

								<h6 class="font-weight-semibold"><i class="icon-law mr-2"></i> Editar departamento seleccionado</h6>
								<p>El departamento seleccionado sera editado dde forma consiente en el sistema informatico</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10" >
										<input type="text" class="form-control" placeholder= "Departamento de Finanzas">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Seccion</label>
									<div class="col-lg-10">
										<input type="password" class="form-control" placeholder="Finanzas">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="0471">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" readonly value="Departamento de Finanzas 0471">
									</div>
								</div>
<!--
								<div class="form-group row">
...
-->
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" value="http://" placeholder="finanzasempresa.com">
									</div>
								</div>
<!--
								<div class="form-group row">
...
-->
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" maxlength="4" placeholder="1998">
									</div>
								</div>
<!--
								<div class="form-group row">
