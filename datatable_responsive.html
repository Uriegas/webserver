		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">En esta seccion podra editar las vacaciones de los empleados seleccionados de la organización.</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Mitlor Rodriguez Garcia">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="password" class="form-control" placeholder="RGM84006AI9">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Clave Empresarial</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="miltonrg95478">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Correo Empresarial</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="miltonrg@limit.mx">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="834 157 8497">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Calle 847 Colonia Mirador">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Julio">
									</div>
								</div>
<!--
								<div class="form-group row">
...
-->
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Cancun">
									</div>
								</div>
<!--
								<div class="form-group row">
