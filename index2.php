					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables">
								<li class="nav-item"><a href="form_input_groups2.php" class="nav-link">Agregar</a></li>
								<li class="nav-item"><a href="form_input_groups2.php" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="datatable_basic2.php" class="nav-link">Enlistar</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables extensions">
								<li class="nav-item"><a href="form_inputs2.php" class="nav-link">Agregar</a></li>
								<li class="nav-item"><a href="formulario_editar2.php" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="datatable_extension_fixed_columns2.php" class="nav-link">Listar</a></li>
								<li class="nav-item"><a href="datatable_extension_fixed_header2.php" class="nav-link">Eliminar</a></li><!--
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Handsontable">
								<li class="nav-item"><a href="handsontable_basic2.php" class="nav-link">Agregar</a></li>
								<li class="nav-item"><a href="handsontable_advanced2.php" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="handsontable_cols2.php" class="nav-link">Listar</a></li>
								<li class="nav-item"><a href="handsontable_cells2.php" class="nav-link">Eliminar</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Responsive tables">
								<li class="nav-item"><a href="table_responsive2.php" class="nav-link">Agregar</a></li>
								<li class="nav-item"><a href="datatable_responsive2.php" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="handsontable_types2.php" class="nav-link">Listar</a></li>
								<li class="nav-item"><a href="handsontable_custom_checks2.php" class="nav-link">Eliminar</a></li><!--
								<li class="nav-item"><a href="handsontable_ac_password.html" class="nav-link">Autocomplete &amp; password</a></li>
								<li class="nav-item"><a href="handsontable_search.html" class="nav-link">Search</a></li>
								<li class="nav-item"><a href="handsontable_context.html" class="nav-link">Context menu</a></li>-->
							</ul>
