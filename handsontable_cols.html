		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Empresas</span> - Enlistar</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						En esta seccion puede observar las especificaciones de cada empresa dentro de la organización.
					</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-3">Se presenta un listadod de las empresas vinculadas con la presente organización.</p>
