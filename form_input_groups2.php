					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables extensions">
								...
								<li class="nav-item"><a href="datatable_extension_row_reorder.html" class="nav-link">Editar</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Empleados</span> - Agregar</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Formularo Empleados</h5>
...
-->
						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Informacion Empleados</legend>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Dirección de correo electrónico</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingrese su domicilio">
											<span class="input-group-append">
											</span>
										</div>
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingrese su Codigo Postal">
											<span class="input-group-append">
											</span>
										</div>
									</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nacionalidad</label>
									<div class="col-lg-10">
										<div class="input-group">
											</span>
											<input type="text" class="form-control" placeholder="Ingrese su país de nacimiento">
											<span class="input-group-append">
											</span>
										</div>
									</div>
							...
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Escriba el nombre de la Empresa">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Escriba la clave de la Empresa">
											<span class="input-group-append">
												<!--<span class="input-group-text"><i class="icon-user"></i></span>-->
											</span>
										</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Escriba la dirección de la Empresa">
											<span class="input-group-append">
							...
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Departamento</legend>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Escriba el nombre del Departamento">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Escriba la clave del Departamento">
											<span class="input-group-append">
												<!--<span class="input-group-text"><i class="icon-spinner2 spinner"></i></span>-->
											</span>
										</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Escriba una breve descripción del departamento">
											<span class="input-group-append">
							...
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre de la Habilidad</label>
									<div class="col-lg-10">
										<div class="input-group">
											<!--<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-user"></i></span>
											</span>-->
											<input type="text" class="form-control" placeholder="Escriba el nombre de su Habilidad">
										</div>
									</div>
								</div>
							</fieldset>
