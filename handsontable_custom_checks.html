		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Vacaciones</span> - Eliminar</h4>
			...
			<!-- Left fixed column -->
				<div class="card">
					...
					<div class="card-body">
						En esta seccion puede eliminar o remover las vacaciones planeadas de cada empleado de la organización.
					...
					<table class="table datatable-fixed-left" width="100%">
					    ...
					    <tbody>
					        <tr>
					            <td>Milton Rodriguez Garcia</td>
					            <td>RGM84006AI9</td>
					            <td>miltonrg95478</td>
					            <td>miltonrg@limit.mx</td>
					            <td>834 157 8497</td>
					            <td>Calle 847 Colonia Mirador</td>
					            <td>Julio</td>
					            <td>Cancun</td>
					        </tr>
					        ...
					        <tr>
					            <td>Elias Charur Lich</td>
					            <td>CLE34006CV2</td>
					            <td>eliascl95478</td>
					            <td>eliascl@limit.mx</td>
					            <td>834 945 9735</td>
					            <td>Calle 9854 Colonia Campestre</td>
					            <td>Julio</td>
					            <td>Paris</td>
					        </tr>

					        <tr>
					            <td>Mario De la Rosa Mazpán</td>
					            <td>MRM84006EI1</td>
					            <td>mariorm95478</td>
					            <td>mariorm@limit.mx</td>
					            <td>834 885 3612</td>
					            <td>Calle 997 Colonia Pajaritos</td>
					            <td>Diciembre</td>
					            <td>Vancouver</td>
					        </tr>

					        <tr>
					            <td>Fernanda Lizhet Fares Latiz</td>
					            <td>FLF84006BC4</td>
					            <td>fernandafl95478</td>
					            <td>fernandafl@limit.mx</td>
					            <td>834 356 9975</td>
					            <td>Calle 949 Colonia Las Rosas</td>
					            <td>Diciembre</td>
					            <td>La Habana</td>
					        </tr>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title"><i class="icon-menu7 mr-2"></i> &nbsp;Eliminar Vacaciones</h5>
							...
							<div class="modal-body">
								<div class="alert alert-info alert-dismissible alert-styled-left border-top-0 border-bottom-0 border-right-0">
					                <span class="font-weight-semibold">Esta a punto de elimnar una de las vacaciones programadas de sus empleados</span>
					                <button type="button" class="close" data-dismiss="alert">×</button>
					            </div>

								<h6 class="font-weight-semibold"><i class="icon-law mr-2"></i> Eliminacion de las vacaciones seleccionadas</h6>
								<p>Las vacaciones seleccionadas seran eliminadas de forma permamanente del sistema informatico</p>
