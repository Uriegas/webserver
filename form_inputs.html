		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Formatos</span> - Agregar Departamentos</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">En esta seccion podra agregar nuevos departamentos a la empresa.</p>
...
-->
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" maxlength="4" placeholder="Introduzca el año en que se creó el departamento">
									</div>
								</div>
<!--
								<div class="form-group row">
