		...
		<div class="content-wrapper">
			...
			<!-- Form inputs -->
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">En esta seccion podra editar la empresas seleccionada de la organización.</p>

						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Datos Principales</legend>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre de la Empresa</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Delymundo">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre Legal</label>
									<div class="col-lg-10">
										<input type="password" class="form-control" placeholder="Delymundo sa. de cv.">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Sierrano De la Garza Victor">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Número de Acciones</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="157,000">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre Accionista Mayor</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Cetura Ventura Esther">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">RFC Accionista Mayor</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="CVER96008AE0">
									</div>
								</div>
<!--
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Resumen Departamento</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" readonly value="En esta seccion se despliega la informacion introducida">
									</div>
								</div>
...
-->
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Direccion Web</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" value="http://delymundo.com">
									</div>
								</div>
<!--
								<div class="form-group row">
...
-->
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Fundacion</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" maxlength="4" placeholder="27 de agosto de 1997">
									</div>
								</div>
<!--
								<div class="form-group row">
...
-->
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<textarea rows="3" cols="3" class="form-control" placeholder="Empresa dedica a la producción y distribución de pasteles y dulces a clientes particulares, en eventos de todo tipo"></textarea>
									</div>
								</div>
							</fieldset>
